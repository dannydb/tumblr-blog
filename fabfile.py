...
env.repo_url = 'git@github.com:dannydb/%(repository_name)s.git' % env
env.alt_repo_url = None  # 'git@bitbucket.org:dannydb/%(repository_name)s.git' % env
env.user = 'ubuntu'
...
def app_template_bootstrap(project_name=None, repository_name=None):
    ...
    local('git remote add origin git@github.com:dannydb/%(repository_name)s.git' % env)
